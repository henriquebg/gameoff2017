...
_UPPER_BORDER EQU $0F
_UPPER_BORDER_OFFSET EQU $14
_LOWER_BORDER EQU $92
_LOWER_BORDER_OFFSET EQU $98
_RIGHT_BORDER EQU $A0
_RIGHT_BORDER_OFFSET EQU $A8
_RIGHT_BORDER_NEGATIVE_OFFSET EQU $97
_LEFT_BORDER EQU $09
